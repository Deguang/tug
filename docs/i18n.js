const translations = {
  "en": {
    ...
    "hero_title_3": "",
    "hero_desc": "Say goodbye to 30 minutes of manual form-filling, 10+ language dropdowns, and 1-pixel rejection agony.<br>Single-source YAML, native localhost CDP direct automation, 3 seconds to ship.",
    ...
    "install_tab_npx": "npx",
    "footer_sub": "MIT License · Official Mascot Tuggy",
    ...
    "metric_1_val": "30m → 15s",
    "metric_1_label": "Release Velocity",
    "metric_1_desc": "From 30-min dashboard form-filling to a 15-second instant mount.",
  ...
  "zh-CN": {
    ...
    "hero_title_em": "git push",
    "hero_title_3": " 一样发版扩展",
    "hero_desc": "30 分钟的机械复制粘贴、十几种语言下拉菜单与尺寸微差拒审，统统归结为一条本地命令。<br>单份 <code>tug.yml</code> 蓝图，CDP 原生直连本地 Chrome 会话，15 秒无感铺设全商店。",
    ...
    "footer_sub": "MIT License · 官方吉祥物 Tuggy",
    ...
    "metric_1_desc": "从痛苦繁琐的后台填表，到 15 秒全自动挂载",
  ...
  "zh-TW": {
    ...
    "hero_title_em": "git push",
    "hero_title_3": " 一樣發版擴充",
    "hero_desc": "30 分鐘的機械複製貼上、十幾種語言下拉選單與尺寸微差拒審，統統歸結為一條本機命令。<br>單份 <code>tug.yml</code> 藍圖，CDP 原生直連本機 Chrome 會話，15 秒無感鋪設全商店。",
    ...
    "metric_1_desc": "從痛苦繁瑣的後台填表，到 15 秒全自動掛載",
  ...
  "ja": {
    ...
    "hero_desc": "45分間の手動入力、10カ国語以上のドロップダウン切り替え、1pxのズレによる審査却下の苦痛から解放。<br>単一の <code>tug.yml</code> とローカルCDP接続で、わずか15秒でストア反映を完了。",
    ...
    "footer_sub": "MIT License · 公式マスコット Tuggy",
    ...
    "term_tab_spec": "tug.yml",
    "metric_1_val": "30分 → 15秒",
    "metric_1_label": "圧倒的な公開速度",
    "metric_1_desc": "手動の管理画面入力から、15秒の自動マウントへ",
  ...
  "ko": {
    ...
    "hero_desc": "45분간의 지루한 폼 입력, 10개 이상의 언어 메뉴 전환, 1픽셀 오차로 인한 반려의 고통에서 해방되세요.<br>단 하나의 <code>tug.yml</code> 파일과 로컬 CDP 연결로 15초 만에 스토어 반영 완료.",
    ...
    "footer_sub": "MIT License · 공식 마스코트 Tuggy",
    ...
    "term_tab_spec": "tug.yml",
    "metric_1_val": "30분 → 15초",
    "metric_1_label": "출시 속도 압축",
    "metric_1_desc": "지루한 대시보드 수동 입력에서 15초 자동 마운트로 단축",
  ...
  "ru": {
    ...
    "install_tab_npx": "npx",
    "footer_sub": "MIT License · Официальный маскот Tuggy",
    ...
    "term_tab_spec": "tug.yml",
    "metric_1_val": "30м → 15с",
    "metric_1_label": "Молниеносный релиз",
    "metric_1_desc": "От рутинного заполнения форм до 15-секундного монтажа",
  ...
  "de": {
    ...
    "hero_title_em": "git push",
    "hero_title_3": "",
    "hero_desc": "Schluss mit 45 Minuten Formularqualen, Dutzenden Sprachmenüs und Ablehnungen wegen 1-Pixel-Fehlern.<br>Single-Source-YAML, direkte lokale CDP-Steuerung und 15 Sek.nden Bereitstellungszeit.",
    ...
    "install_tab_npm": "GitHub Source",
    "install_tab_npx": "npx",
    "footer_sub": "MIT License · Offizielles Maskottchen Tuggy",
    ...
    "metric_1_desc": "Von 30 Min. manuellem Formularausfüllen zu 15 Sek. Auto-Mount",
    "metric_2_val": "0 API-Keys",
  ...
  "fr": {
    ...
    "hero_title_em": "git push",
    "hero_title_3": "",
    "hero_desc": "Oubliez 30 minutes de corvée de formulaires, 10 langues à copier-coller et les rejets pour 1 pixel.<br>Un seul fichier YAML, automatisation locale directe via CDP, publication en 15 secondes.",
    ...
    "install_tab_npx": "npx",
    "footer_sub": "MIT License · Mascotte officielle Tuggy",
    ...
    "metric_1_desc": "De 30 min de formulaires manuels à 15 secondes d’injection",
  ...
  "hi": {
    ...
    "hero_desc": "डैशबोर्ड में 45 मिनट के थकाऊ फॉर्म, 10+ भाषाओं के मेनू और 1 पिक्सेल की अस्वीकृति को अलविदा कहें।<br>एकल YAML विनिर्देश और स्थानीय CDP स्वचालन के साथ सिर्फ 15 सेकंड में सबमिशन।",
    ...
    "install_tab_npx": "npx",
    "footer_sub": "MIT License · आधिकारिक शुभंकर टग्गी",
    ...
    "metric_1_desc": "डैशबोर्ड में मैन्युअल फॉर्म भरने से 15 सेकंड के ऑटो-माउंट तक",
